...
<div class="main">
	...
	<form id="form1" name="form1" method="post" action="${pageContext.request.contextPath }/user/addUser">
			...
			<table class="box">
			   <tbody><tr>
				 ...
				 <tr>
					...
					<td><input type="password" name="repassword" class="text" id="rpassword" value=""> <font color="red">*</font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="birthday" class="text" id="birthDate" value=""> <font color="red">*</font><font color="red" id="birthDate_span"></font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="radio" name="userRole.id" value="1">管理员<input type="radio" name="userRole.id" value="2" checked="true">普通用户
					<input type="radio" name="userRole.id" value="3">经理</td>
				</tr>
			</tbody></table>
		</div>
		<div class="buttons">
