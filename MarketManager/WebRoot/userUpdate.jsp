...
<div class="main">
	...
	<f:form action="${pageContext.request.contextPath }/user/userUpdate" modelAttribute="user" method="post">
		<div class="content">
			<font color="red"></font><table class="box">
			<tbody><tr>
					<td class="field">用户编号：</td>
					<td><f:hidden path="id"/>${id}
			...
			<tr>
				...
				<tr>
					...
					<td><f:select path="gender" items="${sexs}"></f:select></td>
				</tr>
				<tr>
					<td class="field">出生日期：</td>
					<td><input type="text" name="birthday" class="text" id="birthday" value="<fmt:formatDate value="${user.birthday}" pattern="yyyy-MM-dd" />" /> <font color="red">*</font><font color="red" id="birthDate_span"></font></td>
				</tr>
				<tr>
