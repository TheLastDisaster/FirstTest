...
<div class="main">
	<div class="optitle clearfix">
		...
		<div class="buttons">
			<form action="${pageContext.request.contextPath }/bill/updateBillView/${bill.id}" method="post">
				<input type="submit" name="update" id="update" value="修改" class="input-button">
			</form>
			<form action="${pageContext.request.contextPath }/bill/delBill/${bill.id}" method="post">
